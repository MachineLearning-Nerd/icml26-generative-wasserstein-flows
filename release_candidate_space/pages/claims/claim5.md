...
Its assumptions are restricted to the paper's complete reported table domain;
it does not assume access to unreported seed-level samples.
...
The source-table verifier is deterministic. The paper reports a
different-seed table but does not expose the individual seed identifiers.

The [verifier source](../../verification/claim5_source_falsification.py)
