...
The finite counterexample below satisfies the stated probability-measure,
transport-map, and PSD-kernel assumptions.
...
See the [contract](../../evidence/claim4/claim_contract.json),
[source audit](../../evidence/claim4/source_audit.md), and
...
The [verifier source](../../verification/claim4_eq18_falsification.py)
ran successfully as HF run `9cc03198-677d-46e9-857e-5846fe08e772`.
The verifier's frozen Git SHA was
`241a8aeed58b5f5d5dd26f83eb623e7b535db97d`.
...
The analytic and exhaustive finite checks are deterministic and use no seeds.
