...
## Exact claim and update contract
...
See the [contract](../../evidence/claim2/claim_contract.json),
[source audit](../../evidence/claim2/source_audit.md), and
...
The analytic cases and optimizations are deterministic and use no random seeds.

The [verifier source](../../verification/claim2_exact.py)
and [raw result](../../evidence/claim2/raw_result.json) are downloadable.

The negative control replaces `gamma=1/2` by `0.35`, misses every JKO update
by at least `0.02374`, and exits 1; see the
