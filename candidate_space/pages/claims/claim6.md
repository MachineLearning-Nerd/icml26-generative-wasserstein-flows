...
[contract](../../evidence/claim6/claim_contract.json) and
[source audit](../../evidence/claim6/source_audit.md).
...
Replacing `G(theta_plus)` by the identity leaves residual 1.8314 at the
smallest step and the verifier exits 1. See the
...
The [verifier source](https://github.com/MachineLearning-Nerd/icml26-repro-sJ7ngz2eQx-a-unifying-view-of-variational-generative-wasserstein-flows/blob/3c66d998242e2887de319cbbdf52b110dc06d2cd/verification/claim6_preconditioned_flow.py)
