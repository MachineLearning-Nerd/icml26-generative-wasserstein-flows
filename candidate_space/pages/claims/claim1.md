...
See the [exact contract](../../evidence/claim1/claim_contract.json) and
...
The [verifier source](https://github.com/MachineLearning-Nerd/icml26-repro-sJ7ngz2eQx-a-unifying-view-of-variational-generative-wasserstein-flows/blob/c8194ebdf3e34f76d54a2bab1a185e8704949bce/verification/claim1_exact.py)
and [raw result](../../evidence/claim1/raw_result.json) are downloadable.

Removing absolute continuity/Monge recovery admits the countermodel
