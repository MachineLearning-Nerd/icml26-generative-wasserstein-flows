...
| --- | --- | --- | --- | --- |
| [`historical/judged-baseline-5-of-12`](https://github.com/MachineLearning-Nerd/icml26-generative-wasserstein-flows/tree/historical/judged-baseline-5-of-12) | Freeze the judged 5/12 baseline | `uv run --frozen python run_campaign.py` | Historical rejected baseline preserved | HF `cpu-upgrade`, 27 s successful run |
| [`audit/c3-donsker-varadhan-bound`](https://github.com/MachineLearning-Nerd/icml26-generative-wasserstein-flows/tree/audit/c3-donsker-varadhan-bound) | Exact DV certificate | `uv run --frozen python run_campaign.py` | Claim 3 VERIFIED | HF `cpu-upgrade`, 32 s |
| [`audit/c5-fid-consistency`](https://github.com/MachineLearning-Nerd/icml26-generative-wasserstein-flows/tree/audit/c5-fid-consistency) | Exhaust complete FID tables | `uv run --frozen python run_campaign.py` | Claim 5 narrowly FALSIFIED | HF `cpu-upgrade`, 26 s |
| [`audit/c1-vwgf-s-jko-equivalence`](https://github.com/MachineLearning-Nerd/icml26-generative-wasserstein-flows/tree/audit/c1-vwgf-s-jko-equivalence) | Exact VWGF/S-JKO order proof | `uv run --frozen python run_campaign.py` | Claim 1 VERIFIED | HF `cpu-upgrade`, 32 s |
| [`audit/c2-wasserstein-jko-update`](https://github.com/MachineLearning-Nerd/icml26-generative-wasserstein-flows/tree/audit/c2-wasserstein-jko-update) | Exact WGD/JKO update | `uv run --frozen python run_campaign.py` | Claim 2 VERIFIED | HF `cpu-upgrade`, 37 s |
| [`audit/c4-eq18-discriminator`](https://github.com/MachineLearning-Nerd/icml26-generative-wasserstein-flows/tree/audit/c4-eq18-discriminator) | Separate Algorithm 1 from Equation 18 | `uv run --frozen python run_campaign.py` | Claim 4 narrowly FALSIFIED | HF `cpu-upgrade`, 37 s |
| [`audit/c6-parametric-flow`](https://github.com/MachineLearning-Nerd/icml26-generative-wasserstein-flows/tree/audit/c6-parametric-flow) | Nontrivial preconditioning certificate | `uv run --frozen python run_campaign.py` | Claim 6 VERIFIED | HF `cpu-upgrade`, 37 s |
| [`release/cumulative-candidate`](https://github.com/MachineLearning-Nerd/icml26-generative-wasserstein-flows/tree/release/cumulative-candidate) | Cumulative evaluator-visible regression | `uv run --frozen python run_campaign.py` | All six current verdicts pass; controls exit 1 | HF `cpu-upgrade`, 37 s |
